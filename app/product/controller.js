...
const store = (req, res) => {
    ...
    if(image){
        ...
        connection.query({
            ...
            values: [user_id, name, price, stock, status, `http://localhost:3001/public/${image.originalname}`]
        }, _response(res));
    }
}
...
const update = (req, res) => {
    ...
    if(image){
        ...
        values = [user_id, name, price, stock, status, `http://localhost:3001/public/${image.originalname}`, req.params.id];
    }else{
